...
|-------------------------------------       |----------|
| Embedded and Microcontroller               | Understanding of programming languages such as C, C++ and assembly. <br/> Basic awareness of Linux OS, RTOSes. <br/> Fundamental knowledge of hardware and software architecture (Not necessarily Arm) |
